...
function MainSidebar(props) {
  ...
  return (
    ...
    <Navbar className="" bg="white" variant="dark" expand="lg" fixed="top" style={{ width: '250px', height: '100vh', borderRight:'1px solid lightgray'}}>
        ...
        <Nav className="flex-column">
          <NavItem>
            <div className='nav-menu' >
                ...
                <Button variant="link" className="text-black" onClick={handleHomeClick}>홈</Button>
            </div>
          </NavItem>
          <NavItem>
            <div className='nav-menu' >
                <img src={search} style={{ width: 28, height: 28 }} />
                <Button variant="link" className="text-black" onClick={handleSearchClick}>검색</Button>
            </div>
          </NavItem>
          <NavItem>
            <div className='nav-menu' >
            <img src={heart} style={{ width: 30, height: 30 }} />
                <Button variant="link" className="text-black"  onClick={handleLikeClick}>알림</Button>
            </div>
          </NavItem>
          <NavItem>
            <div className='nav-menu' >
